...
const APP: () = {
    ...
    #[idle(resources=[net_interface, iir_state, iir_ch, afes, adc1_routing])]
                    ...
                    server.poll(socket, |req| {
                        ...
                        stabilizer::route_request!(req,
                            ...
                            modifiable_attributes: [
                                ...
                                "stabilizer/route_adc1": &str, (|route_str| {
                                    match route_str {
                                        "ignore" => Ok(ADC1Routing::Ignore),
                                        "sum_with_adc0" => Ok(ADC1Routing::SumWithADC0),
                                        "sum_with_iir0_output" => Ok(ADC1Routing::SumWithIIR0Output),
                                        _ => Err(())
                                    }.and_then(|r| { c.resources.adc1_routing.lock(|cr| *cr = r ); Ok::<(), ()>(()) })
                                })
                            ]
                        )
                    });
